...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->cbLoaixe->SelectedIndexChanged += gcnew System::EventHandler(this, &frmVeThang::cbLoaixe_SelectedIndexChanged);
				 // 
				 // lbGiaVe
				 // 
...
#pragma endregion
	...
	private: void show_Control(bool h) {
				 lbMaThe->Visible = h;
				 txtMaThe->Visible = h;

				 lbTrangThai->Visible = h;
				 txtTrangThai->Visible = h;
			 }
